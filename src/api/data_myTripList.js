...
export const dummyMyTripList = [
    ...
    },
    {
        ...
        city: '강릉',
        firstDate: new Date(2023, 5, 3).getTime(),
        lasgDate: new Date(2023, 5, 4).getTime(),
        recoNum: 168,
        commentNum: 50,
        downloadNum: 65,
        photo:[],
    ...
    },
    {
        ...
        lasgDate: new Date(2023, 11, 26).getTime(),
        recoNum: 238,
        commentNum: 135,
        downloadNum: 102,
        photo:[],
    ...
    },
    {
        ...
        title: '경주 나홀로 여행',
        city: '경주',
        firstDate: new Date(2023, 4, 5).getTime(),
        lasgDate: new Date(2024, 4, 7).getTime(),
        recoNum: 98,
        commentNum: 34,
        downloadNum: 20,
        photo:[],
    ...
    },
    {
        ...
        title: '영종도 여행❤️',
        city: '인천',
        firstDate: new Date(2022, 9, 14).getTime(),
        lasgDate: new Date(2024, 9, 17).getTime(),
        recoNum: 56,
        commentNum: 22,
        downloadNum: 15,
        photo:[],
